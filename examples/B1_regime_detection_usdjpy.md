...
AMATA classifies market structure mechanically using volatility‑driven metrics such as ATR, ADX, tsNorm and TrendScore.  
In this example, USDJPY shifts from a neutral environment into a TrendStart regime, pauses briefly, and then transitions into a stable trend phase before continuing higher.
