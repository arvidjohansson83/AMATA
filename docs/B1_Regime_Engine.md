...
This process is handled by the **Regime Engine**, a core component responsible for transforming raw price behaviour into a structured, machine‑readable market state.
